 ...
 */
{
  ...
  "def": {
    "al": "0x95FF00",                 // ally       / союзник
    "sq": "0xFFDD33",                 // squadman   / взводный
    "tk": "0x00EAFF",                 // teamKiller / тимкиллер
    "en": "0xFF2222",                 // enemy      / противник
    "pl": "0xFCFCFC",                 // player     / игрок
    // Dynamic color by various statistical parameters.
    // Динамический цвет по различным статистическим показателям.
    "colorRating": {
      "very_bad":     "0xFE3C33",     // very bad  / очень плохо
      "bad":          "0xFF8533",     // bad       / плохо
      "normal":       "0xF9F733",     // normal    / средне
      "good":         "0x80FF33",     // good      / хорошо
      "very_good":    "0x00C3F4",     // very good / очень хорошо
      "unique":       "0xBC85FF"      // unique    / уникально
    },

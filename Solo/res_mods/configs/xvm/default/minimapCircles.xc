 ...
 */
{
  "circles": {
    ...
    "view": [
      // Main circles:
      // Основные круги:
      { "enabled": true, "distance": "blindarea", "scale": 1, "thickness": 1.6, "alpha": 85, "color": "0x00AACC" },
      { "enabled": true,  "distance": 445,         "scale": 1, "thickness": 1.6, "alpha": 65, "color": "0xFF2222" },
      ...
      { "enabled": true, "distance": "standing", "scale": 1, "thickness":  0.6, "alpha": 30, "color": "0x00AACC" },
      { "enabled": true, "distance": "motion",   "scale": 1, "thickness":  0.6, "alpha": 30, "color": "0x00AACC" },
      { "enabled": true, "distance": "dynamic",  "scale": 1, "thickness":  1.6, "alpha": 85, "color": "0x00AACC" }
    ],

 ...
 */
{
  ...
  // ???????????? ???? ? ????
  // "auto" - ????????????? ?????????? ???? ??????? ????,
  // ??? ??????? ??? ????? ? ????? res_mods/mods/shared_resources/xvm/l10n/ (????????, "en").
  "language": "auto",
  ...
  "definition": {    // ????? ?????????? ? ???????
    "author":        "Zang_FR",                                        // ????? ???????.
    "description":   "OnlyStats config BETA by Zang_FR",                       // ???????? ???????.
    "url":           "http://forum.worldoftanks.eu/index.php?/topic/734773-1712-",   // ?????, ??? ????????????? ?????????? ???????.
    "date":          " (12.04.20)",                                   // ???? ????????? ??????????? ???????.
    "gameVersion":   "1.8.0.2",                                       // ?????????????? ?????? ????.
    "modMinVersion": "8.4.1_0005"                                          // ?????????? ??????????? ?????? ???? XVM.
  },

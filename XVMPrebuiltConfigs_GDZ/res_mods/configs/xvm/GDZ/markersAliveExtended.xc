 ...
 */
{
  ...
  "def": {
    ...
    "rating": {
      ...
      "format": "<font color='#999999'><font color='{{c:wn8}}'>{{wn8%4d|----}}</font> / <font color='{{c:t-winrate}}'>{{t-winrate%2d~%|--%}}</font></font>"
    },
  ...
  "ally": {
    ...
    "textFields": [
      ...
      ${ "def.rating" },
      ${ "def.xmqpEvent" },
	  ${ "gamemode.xc":"gamemode.markers.PositionSign" },
	  ${ "gamemode.xc":"gamemode.markers.LowHPMarkers" },
	  ${ "gamemode.xc":"gamemode.markers.LowHPMarkers2" }
    ]
  },

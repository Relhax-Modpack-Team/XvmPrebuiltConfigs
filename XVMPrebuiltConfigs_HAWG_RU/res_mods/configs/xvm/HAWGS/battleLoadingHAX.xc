 ...
 */
{
  "templates": {    
    "clanIcon": {
      "enabled": ${"HawgPen/Battle_Loading/Battle_Loading_ClanIcon/OnOff.xc":" enabled"},
      "x": -420, "y": 6, "width": 16, "height": 16, "align": "center", "alpha": 90, "bindToIcon": true,
      "src": "{{clanicon}}"
    },
	"rankBadgeIcon": {
      "enabled": ${"HawgPen/Battle_Loading/Battle_Loading_Rank_Badge_Icon/OnOff.xc":" enabled"},
	 ...
	 "nation": {
      "enabled": ${"HawgPen/Battle_Loading/Battle_Loading_Tanks_Nation_Flag/OnOff.xc":" enabled"},
  ...
  "battleLoading": {   
    "clockFormat": "H:i:s",    
    "removeSquadIcon": ${"HawgPen/Battle_Loading/Battle_Loading_Platoon_Icon/OnOff.xc":" enabled"},    	
    "removeRankBadgeIcon": true,      
    "vehicleIconAlpha": 100,    
    "removeVehicleLevel": ${"HawgPen/Battle_Loading/Battle_Loading_Rank_Tank_Level/OnOff.xc":" enabled"},    
    "removeVehicleTypeIcon": ${"HawgPen/Battle_Loading/Battle_Loading_Tank_Type/OnOff.xc":" enabled"},    
    "nameFieldShowBorder": ${"HawgPen/Battle_Loading/Battle_Loading_Name_Border/OnOff.xc":" enabled"},    
    "vehicleFieldShowBorder": ${"HawgPen/Battle_Loading/Battle_Loading_Icon_Border/OnOff.xc":" enabled"},    
    ...
    "darkenNotReadyIcon": ${"HawgPen/Battle_Loading/Battle_Loading_Player_Not_Connected/OnOff.xc":" enabled"},   

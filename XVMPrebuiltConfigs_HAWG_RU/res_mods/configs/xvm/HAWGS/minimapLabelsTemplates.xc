 ...
 */
{
  ...
  "def": {
	...
	"hpCircles": {
	  "enabled": ${"HawgPen/MiniMap/Hp_Circles_Alive/OnOff.xc":"enabled"},
	  "hotKeyCode": ${"HawgPen/MiniMap/Hp_Circles_Alive/HotKey.xc":"hotkey"},
    ...
    "hpCirclesLost": {
      "enabled": ${"HawgPen/MiniMap/Hp_Circles_Dead/OnOff.xc":"enabled"},
      "$ref": { "path":"def.defaultItem" },

  ...
  "normal": {    
    ...
    "extraFields": [      
      ...
      //===========================================================================================
        ...
        "format": "<font face='Tahoma' size='11'>  уро﻿н:<font face='Tahoma' size='11' color='{{v.c_tdb}}'>{{v.tdb%d}}</font>"
	  ...
	  //===========================================================================================
		...
		"hotKeyCode": 82, "onHold": "false", "visibleOnHotKey": false ,
		"x": 4, "y": 16,
		"format": "<font face='Tahoma' size='12'color='#2FFF6D'>Победа </font>",
		"shadow": {       
          "enabled": true,
          "distance": 3,             
          "angle": 4,                
		...
		//===========================================================================================
		  ...
		  "hotKeyCode": 82, "onHold": "false", "visibleOnHotKey": false ,
		  "x": 4, "y": 33, 
		  "format": "<font face='Tahoma'><font size='12'color='#2FFF6D'>Хит </font>",
		"shadow": {       
          "enabled": true,
          "distance": 3,             
          "angle": 4,                
		...
		"hotKeyCode": 82, "onHold": "false", "visibleOnHotKey": false ,
		"x": 2, "y": 91,
         "format": "<font face='Tahoma' size='14' color='#FFE8FFBF'>чр <font face='Tahoma' size='14' color='#FFE8FFBF'>{{v.maxHP}}</font>",
          "shadow": {       
         "enabled": true,
          "distance": 4,             
          "angle": 5,                

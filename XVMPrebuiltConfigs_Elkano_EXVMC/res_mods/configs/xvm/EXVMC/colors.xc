 ...
 */
{
  ...
  "def": {
    ...
    "colorRatingWoTLabs": {
    //                 client         forums
      "beginner":      "0xBAAAAD", // "0x930D0D",   // beginner
      "basic":         "0xf11919", // "0xCD3333",   // basic
      "below_average": "0xff8a00", // "0xCC7A00",   // below average
      "average":       "0xe6df27", // "0xCCB800",   // average
      "above_average": "0x77e812", // "0x849B24",   // above average
      "good":          "0x459300", // "0x4D7326",   // good
      "very_good":     "0x2ae4ff", // "0x4099BF",   // very good
      "great":         "0x00a0b8", // "0x3161A8",   // great
      "unicum":        "0xc64cff", // "0x60249B",   // unicum
      "super_unicum":  "0x8225ad"  // "0x401070"    // super unicum
    },
    "colorRatingWoW": {
      "undefined": "0x646464",
      "poor":      "0x9D9D9D",
  ...
  "colors": {
    ...
    "x": [
      ...
      // WoTLabs; see: http://forum.wotlabs.net/index.php?/topic/13442-changes-to-the-color-scale/
      // { "value":  16,   "color": ${"def.colorRatingWoTLabs.beginner"      } },
      // { "value":  22.5, "color": ${"def.colorRatingWoTLabs.basic"         } },
      // { "value":  29.5, "color": ${"def.colorRatingWoTLabs.below_average" } },
      // { "value":  38,   "color": ${"def.colorRatingWoTLabs.average"       } },
      // { "value":  48,   "color": ${"def.colorRatingWoTLabs.above_average" } },
      // { "value":  62,   "color": ${"def.colorRatingWoTLabs.good"          } },
      // { "value":  76.5, "color": ${"def.colorRatingWoTLabs.very_good"     } },
      // { "value":  89.5, "color": ${"def.colorRatingWoTLabs.great"         } },
      // { "value":  98,   "color": ${"def.colorRatingWoTLabs.unicum"        } },
      // { "value": 999,   "color": ${"def.colorRatingWoTLabs.super_unicum"  } } 

      // Elkano's WoW style
      { "value":  16.4, "color": ${"def.colorRatingWoW.undefined"} }, // 00 - 16 (<20%)
      { "value":  29.4, "color": ${"def.colorRatingWoW.poor"     } }, // 17 - 29 (>20%)
      { "value":  35.4, "color": ${"def.colorRatingWoW.common"   } }, // 30 - 35 (>50%)
      { "value":  43.4, "color": ${"def.colorRatingWoW.uncommon" } }, // 36 - 43 (>65%)
      { "value":  52.4, "color": ${"def.colorRatingWoW.rare"     } }, // 44 - 52 (>80%)
      { "value":  75.4, "color": ${"def.colorRatingWoW.epic"     } }, // 53 - 75 (>90%)
      { "value":  92.4, "color": ${"def.colorRatingWoW.legendary"} }, // 76 - 92 (>99%)
      { "value": 999,   "color": ${"def.colorRatingWoW.artifact" } }  // 93 - XX (>99.9%)
    ],
    ...
    "winrate": [
      ...
      // WoTLabs
      // { "value": 46,  "color": ${"def.colorRatingWoTLabs.beginner"		} },
      // { "value": 47,  "color": ${"def.colorRatingWoTLabs.basic"			} },
      // { "value": 48,  "color": ${"def.colorRatingWoTLabs.below_average"	} },
      // { "value": 50,  "color": ${"def.colorRatingWoTLabs.average"		} },
      // { "value": 52,  "color": ${"def.colorRatingWoTLabs.above_average"	} },
      // { "value": 54,  "color": ${"def.colorRatingWoTLabs.good"			} },
      // { "value": 56,  "color": ${"def.colorRatingWoTLabs.very_good"		} },
      // { "value": 60,  "color": ${"def.colorRatingWoTLabs.great"			} },
      // { "value": 65,  "color": ${"def.colorRatingWoTLabs.unicum"			} },
      // { "value": 101, "color": ${"def.colorRatingWoTLabs.super_unicum"	} } 

      // Elkano: red (40) -> white (50) -> green (60)
      { "value": 41,  "color": "0xFF0000" },
      { "value": 43,  "color": "0xFF3333" },
      { "value": 45,  "color": "0xFF6666" },
      { "value": 47,  "color": "0xFF9999" },
      { "value": 49,  "color": "0xFFCCCC" },
      { "value": 51,  "color": "0xFFFFFF" },
      { "value": 53,  "color": "0xCCFFCC" },
      { "value": 55,  "color": "0x99FF99" },
      { "value": 57,  "color": "0x66FF66" },
      { "value": 59,  "color": "0x33FF33" },
      { "value": 101, "color": "0x00FF00" }
    ],
    ...
    "kb": [
      ...
      // Elkano
      { "value": 0,   "color": ${"def.colorRatingWoW.undefined"} },
      { "value": 1,   "color": ${"def.colorRatingWoW.poor"     } },
      { "value": 2,   "color": ${"def.colorRatingWoW.common"   } },
      { "value": 5,   "color": ${"def.colorRatingWoW.uncommon" } },
      { "value": 10,  "color": ${"def.colorRatingWoW.rare"     } },
      { "value": 25,  "color": ${"def.colorRatingWoW.epic"     } },
      { "value": 50,  "color": ${"def.colorRatingWoW.legendary"} },
      { "value": 999, "color": ${"def.colorRatingWoW.artifact" } }
    ],
    ...
    "t_battles": [
      ...
      // Elkano
      { "value": 0,     "color": ${"def.colorRatingWoW.undefined"} },
      { "value": 50,    "color": ${"def.colorRatingWoW.poor"     } },
      { "value": 100,   "color": ${"def.colorRatingWoW.common"   } },
      { "value": 250,   "color": ${"def.colorRatingWoW.uncommon" } },
      { "value": 500,   "color": ${"def.colorRatingWoW.rare"     } },
      { "value": 1000,  "color": ${"def.colorRatingWoW.epic"     } },
      { "value": 2500,  "color": ${"def.colorRatingWoW.legendary"} },
      { "value": 99999, "color": ${"def.colorRatingWoW.artifact" } }
    ],

{
  ...
  "colors": {
    "wn8": [
      {
        "value": 300,
        "color": ${"def.colorRatingNew.very_bad"}
      },
      {
        "value": 450,
        "color": ${"def.colorRatingNew.bad"}
      },
      {
        "value": 650,
      ...
      {
        "value": 1200,
        "color": ${"def.colorRatingNew.above_average"}
      },
      {
        "value": 1600,
      ...
      {
        "value": 2900,
        "color": ${"def.colorRatingNew.unicum"}
      },
      {
        "value": 9999,
    ...
    "damage": {
      ...
      "squadman_ally_hit": ${"def.sq2"},
      "squadman_ally_kill": ${"def.sq"},
      "squadman_ally_blowup": ${"def.sq"},
      "squadman_squadman_hit": ${"def.sq2"},

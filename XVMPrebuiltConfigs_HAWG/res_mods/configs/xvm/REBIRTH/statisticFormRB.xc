 ...
 */
{
  "templates": {    
    "clanIcon": {
      "enabled": ${"../../../REBIRTH/Settings/Stats_Form(_tab_button)/Clan_Icon/OnOff.xc":" enabled"},
      "x": -350, "y": 6, "width": 16, "height": 16, "align": "center", "alpha": 90, "bindToIcon": true,
      "src": "{{clanicon}}"
    },
      "rankBadgeIcon": {
      "enabled": ${"../../../REBIRTH/Settings/Stats_Form(_tab_button)/Rank_Icons/OnOff.xc":" enabled"},
	 ...
	 "nation": {
      "enabled": ${"../../../REBIRTH/Settings/Stats_Form(_tab_button)/Tanks_Nation_Flag/OnOff.xc":" enabled"},
      "x": -33, "y": 0, "width": 38, "height": 30, "alpha": "{{alive?100|50}}", "bindToIcon": true,
	  "format": "<img src='cfg://../../REBIRTH/img/battle_nation/{{nation}}.png'>" 
	
	},
	 "flag": {
      "enabled": ${"../../../REBIRTH/Settings/Stats_Form(_tab_button)/Xvm_Users/OnOff.xc":" enabled"},
      "x": -445, "y": 7, "width": 16, "height": 13, "alpha": "{{alive?100|50}}", "bindToIcon": true,
	  "format": "<img src='xvm://res/icons/flags/{{flag|default}}.png'>"
	  
	},
	"xvm-user": {
      "enabled": ${"../../../REBIRTH/Settings/Stats_Form(_tab_button)/Player_Nation_Flag/OnOff.xc":" enabled"},
  ...
  "statisticForm": {    
    "showBattleTier": ${"../../../REBIRTH/Settings/Stats_Form(_tab_button)/Battle_Tier/OnOff.xc":" enabled"},    
    "removeSquadIcon": ${"../../../REBIRTH/Settings/Stats_Form(_tab_button)/Platoon_Icons/OnOff.xc":" enabled"},    
    "removeRankBadgeIcon": true,  
    "vehicleIconAlpha": 100,    
    "removeVehicleLevel": ${"../../../REBIRTH/Settings/Stats_Form(_tab_button)/Tank_Level/OnOff.xc":" enabled"},    
    "removeVehicleTypeIcon": ${"../../../REBIRTH/Settings/Stats_Form(_tab_button)/Tank_Type_Icon/OnOff.xc":" enabled"},    
    "removePlayerStatusIcon": ${"../../../REBIRTH/Settings/Stats_Form(_tab_button)/Player_Status_Icon/OnOff.xc":" enabled"},    
    "nameFieldShowBorder": ${"../../../REBIRTH/Settings/Stats_Form(_tab_button)/Name_Border/OnOff.xc":" enabled"},    
    "vehicleFieldShowBorder": ${"../../../REBIRTH/Settings/Stats_Form(_tab_button)/Tank_Border/OnOff.xc":" enabled"},    
    "fragsFieldShowBorder": ${"../../../REBIRTH/Settings/Stats_Form(_tab_button)/Kill_Count_Border/OnOff.xc":" enabled"},    

...

{
  "damageLog": {
    // false - disable.
    // false - отключить.
	"enabled": ${"../../../REBIRTH/Settings/DamageLog/DamageLog/OnOff.xc":" enabled"},
    
    // true - disable standard detailed damage.
    // true - отключить стандартный детальный урон.
    "disabledDetailStats": ${"../../../REBIRTH/Settings/DamageLog/Disabled_Detail_Stats/OnOff.xc":" enabled"},
    // true - disable standard summarized damage.
    // true - отключить стандартный суммарный урон.
    "disabledSummaryStats": ${"../../../REBIRTH/Settings/DamageLog/Disabled_Summary_Stats/OnOff.xc":" enabled"},
    ...
    "log": {
      ...
      "moveInBattle": ${"../../../REBIRTH/Settings/DamageLog/MoveDamageLog_In_Battle/OnOff.xc":" enabled"},
      "x": 240,
      "y": -23,
      ...
      "c:vtype": {
        "HT": "#FFD800",         // heavy tank / тяжёлый танк.
        "MT": "#77a582",         // medium tank / средний танк.
        "LT": "#87d51d",         // light tank / лёгкий танк.
        "TD": "#0544fe",         // tank destroyer / ПТ-САУ.
        "SPG": "#ff6a00",        // SPG / САУ.
    ...
    "lastHit": {
      ...
      // true - show hits without damage.
      // true - отображать попадания без урона.
      "showHitNoDamage": ${"../../../REBIRTH/Settings/DamageLog/ShowHit_NoDamage/OnOff.xc":" enabled"},

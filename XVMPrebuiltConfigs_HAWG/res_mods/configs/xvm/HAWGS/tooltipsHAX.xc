...
{
  "tooltips": {    
    "combineIcons": ${"HawgPen/Hangar/ToolTips_Combine_Icon/OnOff.xc":" enabled"},     
    "hideSimplifiedVehParams": ${"HawgPen/Hangar/ToolTips_Simplified_Tank_Parms/OnOff.xc":" enabled"},     
    "hideBottomText": ${"HawgPen/Hangar/ToolTips_Bottom_Text/OnOff.xc":" enabled"},     
    "tooltipsDelay": 0.4,    
    "fontSize": 12,    
    "fontName": "$TextFont",    
    "goldColor": "#FFC363",

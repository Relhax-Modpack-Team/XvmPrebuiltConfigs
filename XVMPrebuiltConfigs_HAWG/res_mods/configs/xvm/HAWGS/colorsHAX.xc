 ...
 */
{
  "def": {
    ...
    "sk": "0x000000",  
     ...
     "colorRatingNew": {
      "beginner": ${"HawgPen/Colors/Rating_Colors/10_Beginner/Rating_Color.xc":"color"},
      "basic": ${"HawgPen/Colors/Rating_Colors/9_Basic/Rating_Color.xc":"color"},
      "below_average": ${"HawgPen/Colors/Rating_Colors/8_Below_Average/Rating_Color.xc":"color"},
      "average": ${"HawgPen/Colors/Rating_Colors/7_Average/Rating_Color.xc":"color"},
      "above_average": ${"HawgPen/Colors/Rating_Colors/6_Above_Average/Rating_Color.xc":"color"},
      "good": ${"HawgPen/Colors/Rating_Colors/5_Good/Rating_Color.xc":"color"},
      "very_good": ${"HawgPen/Colors/Rating_Colors/4_Very_Good/Rating_Color.xc":"color"},
      "great": ${"HawgPen/Colors/Rating_Colors/3_Great/Rating_Color.xc":"color"},
      "unicum": ${"HawgPen/Colors/Rating_Colors/2_Unicum/Rating_Color.xc":"color"},
      "super_unicum": ${"HawgPen/Colors/Rating_Colors/1_Super_Unicum/Rating_Color.xc":"color"}
    },

    "colorRating": {
      "undefined": ${"HawgPen/Colors/Rating_Colors/10_Beginner/Rating_Color.xc":"color"},
      "very_bad": ${"HawgPen/Colors/Rating_Colors/9_Basic/Rating_Color.xc":"color"},
	  "bad": ${"HawgPen/Colors/Rating_Colors/8_Below_Average/Rating_Color.xc":"color"},
      "below": ${"HawgPen/Colors/Rating_Colors/7_Average/Rating_Color.xc":"color"},
      "normal": ${"HawgPen/Colors/Rating_Colors/6_Above_Average/Rating_Color.xc":"color"},
      "good": ${"HawgPen/Colors/Rating_Colors/5_Good/Rating_Color.xc":"color"},
      "very_good": ${"HawgPen/Colors/Rating_Colors/4_Very_Good/Rating_Color.xc":"color"},
	  "great": ${"HawgPen/Colors/Rating_Colors/3_Great/Rating_Color.xc":"color"},
	  "unique": ${"HawgPen/Colors/Rating_Colors/2_Unicum/Rating_Color.xc":"color"},
      "super": ${"HawgPen/Colors/Rating_Colors/1_Super_Unicum/Rating_Color.xc":"color"}
    },
  ...
  "colors": {
    ...
    "system": {
      "ally_alive": ${"HawgPen/Colors/Tank_Outlines/Team/OutlineColor.xc":"color"},
      "ally_dead": ${"HawgPen/Colors/Tank_Outlines/Team/OutlineColor.xc":"color"},
      "ally_blowedup":          "0x007700",
      "squadman_alive": ${"HawgPen/Colors/Tank_Outlines/Platoon/OutlineColor.xc":"color"},
      "squadman_dead":          "0xCA7000",
      "squadman_blowedup":      "0xA45A00",
      "teamKiller_alive": ${"HawgPen/Colors/Tank_Outlines/TeamKiller/OutlineColor.xc":"color"},
      "teamKiller_dead":        "0x097783",
      "teamKiller_blowedup":    "0x096A75",
      "enemy_alive": ${"HawgPen/Colors/Tank_Outlines/Enemy/OutlineColor.xc":"color"},
      "enemy_dead": ${"HawgPen/Colors/Tank_Outlines/Enemy/OutlineColor.xc":"color"},
    ...
    "damage": {
      ...
      "ally_enemy_hit": ${"HawgPen/Colors/Tank_Outlines/Enemy/OutlineColor.xc":"color"},
      ...
      "enemy_ally_hit": ${"HawgPen/Colors/Tank_Outlines/Team/OutlineColor.xc":"color"},
      "enemy_ally_kill":              ${"def.al"},
      "enemy_ally_blowup":	           ${"def.al"},
      "enemy_squadman_hit": ${"HawgPen/Colors/Tank_Outlines/Platoon/OutlineColor.xc":"color"},

  ...
  "def": {
   ...
   // "hitLogBody": {
	...
	"timeAIM": { 
	  ...
	  "onHold": "false", "visibleOnHotKey": false ,
      "updateEvent": "PY(ON_CAMERA_MODE), PY(ON_MARKER_POSITION), PY(ON_RELOAD), PY(ON_AIMING)",
	  "x": "{{py:sight.cameraMode=arc?150|236}}",
	  "y": "{{py:sight.cameraMode=arc?-15|{{py:sight.cameraMode=sn?49|45}}}}",
      "width": 150,
      "height": 28,
      "screenHAlign": "center",
      "screenVAlign": "center",
	...
	"timeFlight": {
	  ...
	  "onHold": "false", "visibleOnHotKey": false ,
      "updateEvent": "PY(ON_PLAYER_HEALTH), PY(ON_CAMERA_MODE), PY(ON_MARKER_POSITION),PY(ON_AIMING)",
	  "x": "{{py:sight.cameraMode=arc?150|236}}",
	  "y": "{{py:sight.cameraMode=arc?-33|{{py:sight.cameraMode=sn?69|74}}}}",
      "width": 150,
      "height": 28,
      "screenHAlign": "center",
      "screenVAlign": "center",
    ...
    "name": {
	  ...
	  "onHold": "false", "visibleOnHotKey": false ,
      "updateEvent": "PY(ON_CAMERA_MODE), PY(ON_TARGET),PY(ON_AIMING)",

 ...
 */
{
  ...
  "def": {
      "enemySpottedMarker": {
	  "enabled": ${"HawgPen/PlayersPanel/Enemy_Spotted_Marker/OnOff.xc":" enabled"},
      "alpha": "{{a:spotted}}",
      "x": 54,
      "y": 1,
      "align": "center",
    ...
    "auto_AIM_vehicle": {
      "enabled": ${"HawgPen/Battle/AutoAim_Informer_PlayerPanel/OnOff.xc":" enabled"},
      ...
      "format": "<img src='cfg://HAWGS/img/battle/pp_autoaim.png'>"     
	     
    },
	"xmqpServiceMarker": {
      "enabled": ${"HawgPen/PlayersPanel/Xmqp_Service_Marker/OnOff.xc":" enabled"},
    ...
    "clanIcon": {
      "enabled": ${"HawgPen/PlayersPanel/ClanIcon_NickName_Icon/OnOff.xc":" enabled"},
	...
	//==================================================================	
    "hpBarBg": { 
	"enabled": ${"HawgPen/ALT/PlayersPanel/_Normal/OnOff.xc":" enabled"},
	...
	//==================================================================	
    "bottomhpBarBg": { 
	"enabled": ${"HawgPen/ALT/PlayersPanel/1_HP_Bottom/OnOff.xc":" enabled"},
	"x": 32, 
   ...
   //==================================================================	
    "thinbottomhpBarBg": { 
	"enabled": ${"HawgPen/ALT/PlayersPanel/2_HP_Thin_Bottom/OnOff.xc":" enabled"},
	"x": 32, 
    ...
    //===================================================================
    "extrathinhpBarBg": {
	"enabled": ${"HawgPen/ALT/PlayersPanel/3_HP_Xtra_Thin_Bottom/OnOff.xc":" enabled"},
	"x": 32,
	...
	//===================================================================
	"sidehpBarBg": {
	"enabled": ${"HawgPen/ALT/PlayersPanel/4_HP_On_Side/OnOff.xc":" enabled"},
	...
	//===================================================================
	"sidethinhpBarBg": {
	"enabled": ${"HawgPen/ALT/PlayersPanel/5_HP_Thin_On_Side/OnOff.xc":" enabled"},
	"x": 73,
   ...
   //===================================================================	
	...
	//=================================================================== 
	"sidexthinhpBarBg": {
	"enabled": ${"HawgPen/ALT/PlayersPanel/6_HP_Xtra_Thin_On_Side/OnOff.xc":" enabled"},
	"x": 73,
  ...
  "playersPanel": {
    "enabled": ${"HawgPen/_MainFrame/PlayersPanel/OnOff.xc":" enabled"},
    "alpha": 90,
    "iconAlpha": 100,
    "removeSelectedBackground": ${"HawgPen/PlayersPanel/Selected_Background_Remove/OnOff.xc":" enabled"},
    "removePanelsModeSwitcher": ${"HawgPen/PlayersPanel/Remove_Panels_Mode_Switcher/OnOff.xc":" enabled"},
    "startMode": "large",
    "altMode": null,
    "none": {
      "enabled": true,
    ...
    "short": {
      "enabled": ${"HawgPen/PlayersPanel/Player_Panel_Short/OnOff.xc":" enabled"},
      "standardFields": [ "frags" ],
      "expandAreaWidth": 230,
      "removeSquadIcon": ${"HawgPen/PlayersPanel/Platoon/Platoon.xc":" removeSquadIcon"},
      "squadIconAlpha": 100,
      ...
      "nickFormatRight": "<font alpha='#A0'>{{clan}}</font>{{name%.15s~..}} <font face='mono' size='{{xvm-stat?13|0}}' color='{{c:r}}' alpha='{{alive?#FF|#99}}'>{{r}}</font>",
      "nickShadowLeft": null,
    ...
    "medium": {
      "enabled": ${"HawgPen/PlayersPanel/Player_Panel_Medium/OnOff.xc":" enabled"},
      ...
      "nickMinWidth": 46,
      "nickMaxWidth": 158,
      "nickFormatLeft": "<font color='{{c:r}}' alpha='{{alive?#FF|#99}}'>{{name%.12s~..}}<font alpha='#A0'>{{clan}}</font>",
    ...
    "medium2": {
      "enabled": ${"HawgPen/PlayersPanel/Player_Panel_Medium2/OnOff.xc":" enabled"},
      ...
      "nickMinWidth": 46,
      "nickMaxWidth": 158,
      "nickFormatLeft": "<font color='{{c:r}}' alpha='{{alive?#FF|#99}}'>{{name%.12s~..}}</font> <font alpha='#A0'>{{clan}}</font>",
    ...
    "large": {
      "enabled": ${"HawgPen/PlayersPanel/Player_Panel_Large/OnOff.xc":" enabled"},
      ...
      "nickMinWidth": 46,
      "nickMaxWidth": 158,
      "nickFormatLeft": "<font face='mono' size='{{xvm-stat?13|0}}' color='{{c:r}}' alpha='{{alive?#FF|#99}}'>{{r|--}}<font alpha='#A0'>",
      "nickFormatRight": "<font face='mono' size='{{xvm-stat?13|0}}' color='{{c:r}}' alpha='{{alive?#FF|#99}}'>{{r|--}}<font alpha='#A0'>",
      "nickShadowLeft": {       
         "enabled": true,
          "distance": 2,             
          "angle": 3,                

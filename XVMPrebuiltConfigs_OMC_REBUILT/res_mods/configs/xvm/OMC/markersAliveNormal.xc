 ...
 */
{
  ...
  "ally": {
    ...
    "textFields": [
      ...
      {
        "$ref": { "file": "markersTemplates.xc", "path": "HP-HP-Max"},
        "enabled": true
      },
      {
      ...
      {
        "$ref": { "file": "markersTemplates.xc", "path": "TurretMarker"}
      },
      {
        "$ref": { "file": "markersTemplates.xc", "path": "QuickColorMarker"},
      ...
      {
        "$ref": { "file": "markersTemplates.xc", "path": "xmqpEvent"}
      }
    ]
  },

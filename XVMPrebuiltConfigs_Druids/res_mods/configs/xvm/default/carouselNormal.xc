 ...
 */
{
  ...
  "normal": {
    ...
    "extraFields": [
      ...
      {
        "enabled": true,
        "x": 8, "y": 47, "alpha": "{{v.wn8effd?|0}}",
        "src": "xvm://res/icons/xvm/8x8t.png"
      },
      {
        "enabled": true,
        "x": 17, "y": 41,
        "format": "<b><font face='$FieldFont' size='12' color='{{v.battles>9?{{v.c_wn8effd|#666666}}|#666666}}'>{{v.wn8effd%.2f~}}</font></b>",
        "shadow": ${ "def.textFieldShadow" }
      },
      // Winrate
      // Процент побед

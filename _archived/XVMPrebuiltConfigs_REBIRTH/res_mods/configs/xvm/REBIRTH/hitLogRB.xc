...
{
  "hitLog": {    
    "enabled": ${"../../../REBIRTH/Settings/Battle/Hitlog/OnOff.xc":"enabled"},    
    "showSelfDamage": true,    
    "showAllyDamage": true,    
    "log": {     
      "moveInBattle": false,
      ...
      "formatHistory": "<textformat leading='-4' tabstops='[20,40,60,80]'><font size='12'>\u00D7{{n-player}}:</font><tab><font color='{{c:dmg-kind}}'>{{dmg}}</font><tab>| {{dmg-player}}<tab>|<font color='{{c:vtype}}'>{{vehicle}}</font> <font face='xvm' size='15' color='#FF0000'>{{alive? |{{blownup?&#x7C;|<font size='19'>&#x77;</font>}}}} </font></textformat>"
    },    
    "logAlt": {
      "$ref": { "path":"hitLog.log" },
      "formatHistory": ""

...
//============= clock =========================================================	  
      {
		...
		"format": "<font face='Tahoma' size='25' >{{py:xvm.formatDate('%H:%M ')}}</font><font face='Tahoma' size='22'>{{py:xvm.formatDate('')}}</font>"
    ...
    "formats": [
      {
        ...
        "format": "<font face='$FieldFont'><textformat leading='-30'><font size='27'>{{py:xvm.formatDate('%H:%M ')}}</font><br></textformat><textformat rightMargin='168' leading='-2'>{{py:xvm.formatDate('%Au')}}<br><font size='17'>{{py:xvm.formatDate('%bu %d ')}}</font></textformat></font>"
      },
	  //------PNG
       {
	   "layer": "bottom",
    ...
    "formats": [
      {
        ...
        "shadow": { "enabled": true, "distance": 0, "angle": 0, "color": "0x000000", "alpha": 80, "blur": 4, "strength": 2},        
        "textFormat": { "align": "right", "valign": "top", "color": "0xa8ffbb" },        
        "format": "<font face='$FieldFont'><textformat leading='-30'><font size='30'>{{py:xvm.formatDate('%H:%M ')}}</font><br></textformat><textformat rightMargin='168' leading='-2'>{{py:xvm.formatDate('%Au')}}<br><font size='17'>{{py:xvm.formatDate('%bu %d ')}}</font></textformat></font>"
      },
	  //------PNG
       {
	   "layer": "bottom",
    ...
    "formats": [
      {
        ...
        "format": "<font face='$FieldFont'><textformat leading='-35'><font size='35'>{{py:xvm.formatDate('%H:%M ')}}</font><br></textformat><textformat rightMargin='168' leading='-2'>{{py:xvm.formatDate('%Au')}}<br><font size='18'>{{py:xvm.formatDate('%bu %d ')}}</font></textformat></font>"               
      },
       {
       "x":0, 
       "y": 80,  
  ...
  "twoclock": {
    ...
    "formats": [
        ...
        
      {
        ...
        "textFormat": { "align": "right", "valign": "top", "color": "0xa8ffbb" },        
        "format": "<font face='$FieldFont' size='25'>{{py:xvm.formatDate('%H:%M :%S ')}}</font></font>"
      },
    ...
    "formats": [
      {
		...
		"strength": 2},
        "textFormat": { "align": "right", "valign": "top", "color": "0x0xA2A2A4" },
        "format": "<font size='38'>{{py:xvm.formatDate('%H:%M ')}}</font></textformat></font>"

 ...
 */
{
  ...
  "def": {
    ...
    "damageText": {
      ...
      //"damageMessage": "{{dmg}}",
      "damageMessage": "<font color='{{c:system}}' face='$FieldFont' size='13'><textformat leading='-8'><img src='xvm://res/markers/damage/{{c:system}}.png' width='45' height='60' vspace='-6'><font size='22'><b>{{dmg}}</b></font>\n<b>{{vehicle}}</b> <font size='21'>{{vtype}}</font></textformat></font>",
      // Text for ammo rack explosion (see description of macros in the macros.txt).
      //"blowupMessage": "{{l10n:blownUp}}\n{{dmg}}"
      "blowupMessage": "<font color='{{c:system}}' face='$FieldFont' size='13'><textformat leading='-8'><img src='xvm://res/markers/damage/{{c:system}}.png' width='45' height='60' vspace='-6'><font size='22'><b>{{dmg}}</b></font>\n<b>{{vehicle}}</b> <font size='21'>{{vtype}}</font></textformat></font>"
    }
  },
  // Settings for allies.
  "ally": {

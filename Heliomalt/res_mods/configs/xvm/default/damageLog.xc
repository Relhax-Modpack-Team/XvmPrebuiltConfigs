...

{
  "damageLog": {
    // false - disable.
    "enabled": false,
    // false - disable standard detailed damage.
    "disabledDetailStats": false,
    // false - disable standard summarized damage.
    "disabledSummaryStats": false,
    // Log of the received damage.
    "log": {
      //false - allow to move log in battle and disallow macros for "x" and "y" settings
      ...
      // false - show hits without damage.
      "showHitNoDamage": false,
      // false - summarize damages from fire.
      "groupDamagesFromFire": false,
      // false - summarize damages from ramming, crash, falling (if more than one damage per second).
    ...
    "lastHit": {
      "$ref": { "path":"damageLog.log" },
      //false - allow to move last damage in battle and disallow macros for "x" and "y" settings

 ...
 */
{
  ...
  "def": {
    ...
    "playerName": {
      ...
      "format": "<font size='{{battletype?13|{{squad?13|0}}}}'>{{name}}</font>"  // ?????? ??????. ??. ???????? ???????? ? macros.txt
    },
    ...
    "stats": {
      ...
      "format": "{{kb%d~k|-k}} {{avglvl%d|-}} {{winrate%d~%|--%}} {{wn8%4d|----}}"
    },

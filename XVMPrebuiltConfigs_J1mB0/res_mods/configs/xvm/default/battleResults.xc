 ...
 */
{
  "battleResults": {
    ...
    // true - oтображать общий полученный опыт на первой странице
    "showTotalExperience": true,
    // true - display crew experience in first page
    // true - oтображать опыт экипажа на первой странице
    "showCrewExperience": false,
    // true - display net income of credits in first page
    // true - oтображать чистый доход на первой странице
    "showNetIncome": true,
    // true - display shots precision and damage in first page under credits and XP
    // true - oтображать процент попаданий и урон на первой странице, под кредитами и опытом

  ...
  "captureBar": {
    ...
    "enemy": {
      ...
      "title": {
        ...
        "done": "<font size='15' color='#F71408'>{{l10n:allyBaseCaptured}}</font> <font size='14' color='#F0F0F0'>({{cap.points}})</font>",
        // Shadow options.
        // Параметры тени.
        "shadow": {
          // false - no shadow.
    ...
    "ally": {
      ...
      "title": {
        ...
        "done": "<font size='15' color='#76CA08'>{{l10n:enemyBaseCaptured}}</font> <font size='14' color='#F0F0F0'>({{cap.points}})</font>"
      },

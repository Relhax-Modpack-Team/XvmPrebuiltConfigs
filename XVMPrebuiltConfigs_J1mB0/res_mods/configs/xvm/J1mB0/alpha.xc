 ...
 */
{
  ...
  "def": {
    ...
    "alphaRating": {
      ...
      "bad":           "100",   // bad         / плохо
      "normal":        "100",   // normal      / средне
      "good":          "100",   // good        / хорошо
      "very_good":     "100",    // very good  / очень хорошо
    ...
    "alphaHP": {
      ...
      "low":           "100",   // low             / низкий
      "average":       "100",   // average         / средний
      "above_average": "100"     // above-average  / выше среднего
    }
  },
  "alpha": {
    ...
    "eff": [
      { "value": 610,  "color": ${"def.alphaRating.very_bad" } },  //    0 - 609  - very bad   (20% of players)
      { "value": 875,  "color": ${"def.alphaRating.bad"      } },  //  610 - 874  - bad        (better than 20% of players)
      { "value": 1175, "color": ${"def.alphaRating.normal"   } },  //  875 - 1174 - normal     (better than 60% of players)
      { "value": 1540, "color": ${"def.alphaRating.good"     } },  // 1175 - 1539 - good       (better than 90% of players)
      { "value": 1880, "color": ${"def.alphaRating.very_good"} },  // 1540 - 1879 - very good  (better than 99% of players)
      { "value": 9999, "color": ${"def.alphaRating.unique"   } }   // 1880 - *    - unique     (better than 99.9% of players)
    ],
    // Dynamic transparency by WN6 rating
    // Динамическая прозрачность по рейтингу WN6
    "wn6": [
      { "value": 470,  "color": ${"def.alphaRating.very_bad" } },  //    0 - 469  - very bad   (20% of players)
      { "value": 860,  "color": ${"def.alphaRating.bad"      } },  //  470 - 859  - bad        (better than 20% of players)
      { "value": 1225, "color": ${"def.alphaRating.normal"   } },  //  860 - 1224 - normal     (better than 60% of players)
      { "value": 1635, "color": ${"def.alphaRating.good"     } },  // 1225 - 1634 - good       (better than 90% of players)
      { "value": 1990, "color": ${"def.alphaRating.very_good"} },  // 1635 - 1989 - very good  (better than 99% of players)
      { "value": 9999, "color": ${"def.alphaRating.unique"   } }   // 1990 - *    - unique     (better than 99.9% of players)
    ],
    // Dynamic transparency by WN8 rating
    // Динамическая прозрачность по рейтингу WN8
    "wn8": [
      { "value": 400,  "color": ${"def.alphaRating.very_bad" } },  //    0 - 399  - very bad   (20% of players)
      { "value": 900,  "color": ${"def.alphaRating.bad"      } },  //  400 - 899  - bad        (better than 20% of players)
      { "value": 1470, "color": ${"def.alphaRating.normal"   } },  //  900 - 1469 - normal     (better than 60% of players)
      { "value": 2180, "color": ${"def.alphaRating.good"     } },  // 1470 - 2179 - good       (better than 90% of players)
      { "value": 2880, "color": ${"def.alphaRating.very_good"} },  // 2180 - 2879 - very good  (better than 99% of players)
      { "value": 9999, "color": ${"def.alphaRating.unique"   } }   // 2880 - *    - unique     (better than 99.9% of players)
    ],
    // Dynamic transparency by WG rating
    // Динамическая прозрачность по рейтингу WG
    "wgr": [
      { "value": 2555,  "color": ${"def.alphaRating.very_bad" } },  //    0 - 2554 - very bad   (20% of players)
      { "value": 4435,  "color": ${"def.alphaRating.bad"      } },  // 2555 - 4434 - bad        (better than 20% of players)
      { "value": 6515,  "color": ${"def.alphaRating.normal"   } },  // 4435 - 6514 - normal     (better than 60% of players)
      { "value": 8730,  "color": ${"def.alphaRating.good"     } },  // 6515 - 8729 - good       (better than 90% of players)
      { "value": 10175, "color": ${"def.alphaRating.very_good"} },  // 8730 -10174 - very good  (better than 99% of players)
      { "value": 99999, "color": ${"def.alphaRating.unique"   } }   //10175 - *    - unique     (better than 99.9% of players)
    ],
    ...
    "avglvl": [
      { "value": 2,   "alpha": ${"def.alphaRating.very_bad" } },
      { "value": 3,   "alpha": ${"def.alphaRating.bad"      } },
      { "value": 5,   "alpha": ${"def.alphaRating.normal"   } },
      { "value": 7,   "alpha": ${"def.alphaRating.good"     } },
      { "value": 9,   "alpha": ${"def.alphaRating.very_good"} },
      { "value": 11,  "alpha": ${"def.alphaRating.unique"   } }
    ],

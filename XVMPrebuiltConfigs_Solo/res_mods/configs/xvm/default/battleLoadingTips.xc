 ...
 */
{
  "templates": {
    ...
    "clanIcon": {
      "enabled": true,
      "x": -388, "y": 1, "width": 24, "height": 24, "align": "center", "alpha": 90, "bindToIcon": true,
      "src": "{{clanicon}}"
    }
  },
  "battleLoadingTips": {
